...
export const SignUp = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <NavLink to={'/signIn'} className="bg-gradient-to-r from-yellow-200 via-yellow-500 to-yellow-800 bg-clip-text text-transparent text-sm mt-1">Sign In if you already have an account</NavLink>
    </div>
  );
};
